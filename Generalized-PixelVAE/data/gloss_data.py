...
class DataLoader(object):
    ...
    def __init__(self, data_dir, subset, batch_size, rng=None, shuffle=False, return_labels=False):
        ...
        self.data= load("../GlossDataset/unsupervised_gloss_training_data_and_models/training_images_10k_128x128/images/", subset=subset)
        
        #self.data = np.transpose(self.data, (0,2,3,1)) # (N,3,32,32) -> (N,32,32,3)
        if subset == "test": self.data = self.data[:100]
