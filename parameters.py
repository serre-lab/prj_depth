...
## Light Parameters
light_levels = 10 # the number of shading qualities. Each quality will be refered to by an index (0 = best), which will be used to index into arrays of other parameters.
...
## Surface Parameters
num_surfaces = 1 # number of surfaces 
terrain_size = 4 # size (square length) of the terrain generated by ANT Landscape plug-in
...
cloth_size = 5 # the size of the cloth (square length) dropped onto the surface
